...
| E4 | **Fit a simple model** | Connect a visible model shape to parameters and fit a simple function over a justified range. | `TF1`, `Fit` | **NEXT** |
...
The default next lesson on this roadmap is **E4 — Fit a simple model**.
